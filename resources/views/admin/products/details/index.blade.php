    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                <a href="{{ route('admin.product.index') }}"><u>Listar produtos</u></a> > {{ $service->name }}
            </h2>
        </div>
    </div>
                        ...
                        <div class="card-deck mb-4">
                            ...
                            <div class="card border-0 bg-transparent">
                                <div class="card-img-top img-fluid rounded"
                                    style='background-image:url("/storage/{{ $service->photo }}");background-position:center;background-size:cover;height:400px;'>
                                </div>
