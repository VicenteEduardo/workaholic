                        ...
                        <tr data-id="{{ $id }}">
                            ...
                            <td>
                                <div class="input-counter">
                                    ...
                                    <input class="form-control quantity update-cart" type="text" min="1" value="{{ $details['quantity'] }}" />
                            ...
                            <td class="actions" data-th="">
                                <a href="#" class="id-modal-trigger" data-id="{{ $id }}"
                                    title="Eliminar" data-toggle="modal" data-target="#myModal"><i class="far fa-trash-alt"></i></a>
                            </td>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="input-groupj">
                        ...
                        <tr>
                            <td colspan="5" class="text-right"><h3><strong>Total: {!! number_format( $total, 2, ',', '.') . ' ' . 'KZ' !!} </strong></h3></td>
                        </tr>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-5 col-sm-4 col-12">
                    ...
                    <a class="default-button dfb" href="{{ route('cart') }}"><span>Update Cart</span></a>
                </div>
            </div>
        </div>
    </div>
