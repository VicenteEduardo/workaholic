...
d[c]=f,"o"===b[1]&&G(a[f]))});a._hungarianMap=d}function O(a,b,c){a._hungarianMap||G(a);var d;k.each(b,function(f,e){d=a._hungarianMap[f];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),k.extend(!0,b[d],b[f]),O(a[d],b[d],c)):b[d]=b[f])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Va(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Sem dados disponíveis na tabela"===b.sEmptyTable&&V(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&V(a,a,
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Mostrando _START_ de _END_ para _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 de 0 para 0 entradas",sInfoFiltered:"(filtrado de _MAX_ entradas no total)",
  sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu:"Exposição _MENU_ entradas",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"<b class='text-dark'>Pesquisar:</b>",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro correspondente encontrando!"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
